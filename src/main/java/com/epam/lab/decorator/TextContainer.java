    ...
    public String getText() {
        if (wrappedElement != null) {
            try {
                ...
                log.debug(Localization.getMessage(Localization.TEXT_CONTAINER_GET, containerValue, name, page));
        ...
        log.error(Localization.getMessage(Localization.NO_TEXT_CONTAINER, name, page));
        return null;
    }
}
